export async function onRequestPost(context) {
  try {
    console.log('Cloudflare Function: Received POST request to extractArticles');
    ...
    console.log('Returning', mockArticles.length, 'mock articles');
    ...
    console.error('Error in extractArticles function:', error);
    return new Response(JSON.stringify({
      success: false,
