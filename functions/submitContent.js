// Cloudflare Worker function for handling content submissions
export async function onRequestPost(context) {
  ...
  try {
    ...
    return new Response(JSON.stringify({ 
      success: false,
      message: 'There was an error processing your submission. Please try again or contact us directly.'
    }), {
      status: 500,
      headers: {
        'Content-Type': 'application/json',
